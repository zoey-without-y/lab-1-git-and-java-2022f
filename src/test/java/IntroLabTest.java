...
public class IntroLabTest {
    ...
    @Test
    public void testKiikMarj() {
        String expected = "Hey! My name is Marja-Leena Kiik! " +
                "I like dogs more than cats! Looking forward to CS this year!";
        String actual = IntroLab.kiikMarj();
        assertEquals(expected, actual);
    }
}
